        ...
        <div className="m-footer">
          ...
          <div className="m-footer__container">
            <div>
              ...
              <a target="_blank" href="https://samlansdaal.myportfolio.com/"><img className="m-footer__icon" src={globe} alt=""/></a>
            </div>
            <div>
            ...
            <div>
              ...
              <a target="_blank" href="https://gosro-poorheydar.webnode.nl/"><img className="m-footer__icon" src={globe} alt=""/></a>
            </div>
          </div>
        </div>
    )
